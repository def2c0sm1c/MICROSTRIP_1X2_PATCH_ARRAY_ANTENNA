...
The antenna consists of two rectangular microstrip patches connected through a corporate feed network with a quarter-wave impedance transformer. The design was simulated in CST Studio Suite and subsequently fabricated on an FR-4 Lossy for experimental characterization.
...
CST Studio Suite · Microstrip Patch Array Design · Antenna Fabrication · VNA Measurement · S₁₁ Analysis · · Simulation vs Fabricated design Measurement Analysis · RF & Microwave Engineering
